export const ko = {
  ...
  settings: {
    ...
    googleCalendar: {
      ...
      reauthorizationRequired: '다시 인증 필요',
      loading: '캘린더 연결 상태를 불러오는 중…',
      clientSetup:
        '이 빌드에는 Google Calendar가 설정되지 않았습니다. 데스크톱 실행 또는 패키징 전에 FRILDAY_GOOGLE_CLIENT_ID를 설정하세요.',
      calendars: '가져올 캘린더 선택',
      primary: '기본',
      noCalendars: '이 계정에서 읽을 수 있는 캘린더가 없습니다.',
      selectAtLeastOne: '가져올 캘린더를 하나 이상 선택하세요.',
      saved: '캘린더 선택을 저장했습니다.',
    },
  },
};
