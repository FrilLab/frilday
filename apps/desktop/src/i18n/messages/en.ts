export const en = {
  ...
  schedule: {
    ...
    dailyLoad: 'Daily planned load',
    maxDay: 'Peak day: {duration}',
  ...
  settings: {
    ...
    googleCalendar: {
      ...
      reauthorizationRequired: 'Reconnect required',
      loading: 'Loading calendar connection…',
      clientSetup:
        'Google Calendar is not configured for this build. Set FRILDAY_GOOGLE_CLIENT_ID before running or packaging the desktop app.',
      calendars: 'Calendars allowed for import',
      primary: 'Primary',
      noCalendars: 'No readable calendars were found for this account.',
      selectAtLeastOne: 'Select at least one calendar to import from.',
      saved: 'Calendar selection saved.',
    },
  },
};
