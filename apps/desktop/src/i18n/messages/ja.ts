export const ja = {
  ...
  settings: {
    ...
    googleCalendar: {
      ...
      connected: '接続済み',
      disconnected: '未接続',
      reauthorizationRequired: '再認証が必要です',
      loading: 'カレンダー接続を読み込み中…',
      clientSetup:
        'このビルドでは Google カレンダーが設定されていません。デスクトップの実行またはパッケージ前に FRILDAY_GOOGLE_CLIENT_ID を設定してください。',
      calendars: '読み込むカレンダー',
      primary: 'メイン',
      noCalendars: 'このアカウントで読み取り可能なカレンダーがありません。',
      selectAtLeastOne: '読み込むカレンダーを1つ以上選択してください。',
      saved: 'カレンダーの選択を保存しました。',
    },
  },
};
